...
$(document).ready(function() {  //beginning of document ready
    ...
    $('html').keyup(function(e) { //this will capture any 'keyup' event on any part of the browser page
        ...
        switch(userInput) {
            case 37:
                $("#key-pressed").html("left").prepend($('<img>',{id:'#key-pressed',src:'img/konami/left-arrow.png'}));
                bucketArray.push("l");
                break;
            case 38:
                $("#key-pressed").html("up arrow").prepend($('<img>',{id:'#key-pressed',src:'img/konami/up-arrow.png'}));
                bucketArray.push("u");
                break;
            case 39:
                $("#key-pressed").html("right arrow").prepend($('<img>',{id:'#key-pressed',src:'img/konami/right-arrow.png'}));
                bucketArray.push("r");
                break;
            case 40:
                $("#key-pressed").html("down arrow").prepend($('<img>',{id:'#key-pressed',src:'img/konami/down-arrow.png'}));
                bucketArray.push("d");
                break;
            case 66:
                $("#key-pressed").html("B").prepend($('<img>',{id:'#key-pressed',src:'img/konami/letter-b.png'}));
                bucketArray.push("b");
                break;
            case 65:
                $("#key-pressed").html("A").prepend($('<img>',{id:'#key-pressed',src:'img/konami/letter-a.png'}));
                bucketArray.push("a");
                break;
            case 13:
                $("#key-pressed").html("enter").prepend($('<img>',{id:'#key-pressed',src:'img/konami/return-arrow.png'}));
