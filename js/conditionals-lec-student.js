...
//     console.log("Displaying admin nav bar");
// }
...
//     console.log("Displaying admin nav bar");
// } else {
//     console.log("Display the regular nav bar")
// }
...
//     alert(numberInput + " is greater than 10");
// } else {
//     alert('the number ' + numberInput+ ' is less than 10');
// }
//
...
// var streetLight = prompt("what color is the street light you're coming to?");
// console.log("Street light color: " + streetLight);
//
// function trafficLight(streetLight) {
//     if (streetLight === "red") {
//         alert("STOP!  You're at a " + streetLight + " light.");
//     } else if (streetLight === "yellow") {
//         alert("Think about slowing down.  Looks like the light is " + streetLight);
//     } else {
//         alert("Keep going.  The light is " + streetLight);
//     }
// }
...
console.log("user pizza input is: " + pizzaChoice);
